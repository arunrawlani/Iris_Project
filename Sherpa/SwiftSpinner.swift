...
public class SwiftSpinner: UIView {
    ...
    public override init(frame: CGRect) {
        ...
        outerCircle.fillColor = UIColor.clearColor().CGColor //changed here
        ...
        innerCircle.fillColor = UIColor.clearColor().CGColor //changed here
        innerCircle.strokeColor = UIColor.whiteColor().CGColor //changed here
        ...
        dispatch_async(dispatch_get_main_queue(), {
            ...
            UIView.animateWithDuration(0.33, delay: 0.0, options: .CurveEaseOut, animations: {
                spinner.alpha = 0.0
                    ...
                    spinner.titleLabel.textColor = UIColor.whiteColor()
                    completion?()
            })
...
//    }
    ...
    var defaultTitleFont = UIFont(name: "AvenirNext-Medium", size: 22.0)!
